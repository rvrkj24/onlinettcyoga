...
//				for ( $n = sizeof( $this->missing_menu_items ), $i = $n - 1; $i >= 0; $i -- ) {
//					$missing_id = intval( $this->missing_menu_items[$i]['post_id'] );
//					if ( $missing_id == $old_id ) {
//						unset( $this->missing_menu_items[$i] );
//						break;
//					}
//				}
//			}
